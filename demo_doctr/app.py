...
if is_tf_available():
    ...
    from backend.tensorflow000 import DET_ARCHS, RECO_ARCHS, forward_image, load_predictor
    ...
    import torch
    from backend.pytorch000 import DET_ARCHS, RECO_ARCHS, forward_image, load_predictor
...
def main(det_archs, reco_archs):
    ...
    st.sidebar.write("powered by docTR python library")
